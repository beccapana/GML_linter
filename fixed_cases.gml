...
var tooLongLine = "Lorem ipsum dolor sit amet,
consectetur adipiscing elit. Nam efficitur nisi at ultrices imperdiet.";
...
// Отсутствие пробела после запятой (будет
// исправлено)
array = [ 1, 2, 3, 4 ];
...
// Этот комментарий содержит несколько слов,
// которые должны быть перенесены на
// следующую строку, чтобы соблюсти длину
...
// Синтаксическая ошибка в управляющем
// операторе
while (true) { 
    show_message("While loop"); // отсутствует закрывающая скобка
 }

// Это не camelCase, имя переменной не
// соответствует соглашению о именовании
